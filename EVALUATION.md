...
- event replayability assessment count,
- event replayability ready count,
- event replayability object reconstruction ready count,
- event replayability full state reconstruction ready count,
- event replayability missing capability count,
- event replayability payload gap count,
- event replayability diff gap count,
- event replayability state mutation count,
- event replayability execution count,
- reconstruction evidence schema report count,
- reconstruction evidence schema section count,
- reconstruction evidence missing requirement count,
- reconstruction evidence target path requirement count,
- reconstruction evidence schema mutation count,
...
- reconstruction evidence gap prioritization count,
- reconstruction evidence prioritized workflow count,
- reconstruction evidence high priority workflow count,
- reconstruction evidence max priority score,
- reconstruction evidence priority schema mutation count,
- reconstruction evidence priority capture execution count,
- reconstruction evidence priority reconstruction execution count,
- reconstruction evidence priority state mutation count,
- reconstruction evidence schema checklist count,
- reconstruction evidence schema checklist item count,
- reconstruction evidence schema checklist high priority count,
- reconstruction evidence schema checklist question count,
- reconstruction evidence schema checklist acceptance count,
- reconstruction evidence schema checklist required evidence count,
- reconstruction evidence schema checklist schema mutation count,
- reconstruction evidence schema checklist capture execution count,
...
- reconstruction schema review evidence request tracker count,
- reconstruction schema review evidence request count,
- reconstruction schema review open evidence request count,
- reconstruction schema review satisfied evidence request count,
- reconstruction schema review evidence request decision count,
- reconstruction schema review evidence request schema mutation count,
- reconstruction schema review evidence request capture execution count,
- reconstruction schema review evidence request reconstruction execution count,
