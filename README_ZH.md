...
当前工作状态：P143 Response Orchestration Preview RFC 已完成。future response orchestration 被定义为 preview-first，model output 默认 untrusted 且保持在 core state 之外；orchestration、prompt building、model calls、writes、tools、adapters 和 rebuild 仍保持 blocked。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P143 foundation phase index，按核心命题和所属主线整理。
