...
当前工作状态：P109 Harness Roadmap 已完成。当前 `harness-dry-run` 被定义为压力观察器，
不是交互 runtime：它能显示 deterministic pressure routing、candidates、review gates 和 boundaries，
但仍不能做真实 retrieval、写入、adapter、工具执行或产品行为。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P109 foundation phase index，按核心命题和所属主线整理。
