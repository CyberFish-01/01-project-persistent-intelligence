...
当前工作状态：P106 Harness Candidate Preview Specialization 已完成。本地只读 `harness-dry-run`
现在为每个 candidate 提供 pressure-specific intent、selection reason、blocked-promotion reason 和
manual review target；仍保持 preview-only。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P106 foundation phase index，按核心命题和所属主线整理。
