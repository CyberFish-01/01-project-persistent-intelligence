...
当前工作状态：P114 Read-Only Source Loader Plan 已完成。future source loader 在实现前已经有 planned
functions、record shape、whitelist rules、disallowed reads、tests、CLI boundary 和 harness integration
boundary。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P114 foundation phase index，按核心命题和所属主线整理。
