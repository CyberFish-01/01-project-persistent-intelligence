...
当前工作状态：P147 Rebuild Migration Protocol RFC 已完成。future local rebuild 现在有 entry gates、source trust rules、migration non-goals 和 stop conditions；old 01 reads、migration execution、writes、reducers、adapters、model calls、tools 和 rebuild 仍保持 blocked。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P147 foundation phase index，按核心命题和所属主线整理。
