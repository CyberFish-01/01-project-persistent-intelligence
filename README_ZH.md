...
当前工作状态：P144 LLM-as-Resource Boundary RFC 已完成。future LLM calls 被定义为只是一种 resource usage，output 默认 untrusted 且保持在 subject ownership 之外；model calls、prompt engines、writes、tools、adapters、policy execution 和 rebuild 仍保持 blocked。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P144 foundation phase index，按核心命题和所属主线整理。
