...
当前工作状态：P137 Context Package Builder RFC 已完成。项目现在有 future model-as-resource work 所需的 context package shape，但 builder implementation、retrieval execution、model calls、writes、adapters、tools 和 rebuild 仍保持 blocked。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P137 foundation phase index，按核心命题和所属主线整理。
