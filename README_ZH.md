...
当前工作状态：P140 Boundary Injection RFC 已完成。future context packages 必须在 package 内携带 boundary reminders，同时 enforcement、runtime guards、prompt builders、model calls、writes、adapters、tools 和 rebuild 仍保持 blocked。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P140 foundation phase index，按核心命题和所属主线整理。
