...
当前工作状态：P131 Founder Console Boundary RFC 已完成。下一步接近应用层的表面被定义为 local、founder-only、no-write visibility，而不是 Web UI、Companion、adapter integration、model calls、write paths、policy execution 或 rebuild。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P131 foundation phase index，按核心命题和所属主线整理。
