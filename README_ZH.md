...
当前工作状态：P156 Baseline Tagging and Branch Creation Plan 已在本地完成。P154 audit 已确认仓库
push-ready；P155 加入 lineage governance；P156 为 founder review 提出 candidate baseline tags、
milestone tags 和 sandbox branches。push、创建 tag、创建 branch 和 rebuild 仍需要 founder /
operator 明确确认。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P156 foundation phase index，按核心命题和所属主线整理。
...
- [FOUNDER_CONSOLE_BOUNDARY_RFC.md](./FOUNDER_CONSOLE_BOUNDARY_RFC.md) / [FOUNDER_CONSOLE_BOUNDARY_RFC_ZH.md](./FOUNDER_CONSOLE_BOUNDARY_RFC_ZH.md)：P131 RFC-only boundary，定义 local、founder-only、no-write visibility surface。
- [FOUNDER_CONSOLE_USER_FLOW.md](./FOUNDER_CONSOLE_USER_FLOW.md) / [FOUNDER_CONSOLE_USER_FLOW_ZH.md](./FOUNDER_CONSOLE_USER_FLOW_ZH.md)：P132 document-only founder-console flow，从 status visibility 到 preview 再到 manual decision。
- [FOUNDER_CONSOLE_NO_WRITE_CONTRACT.md](./FOUNDER_CONSOLE_NO_WRITE_CONTRACT.md) / [FOUNDER_CONSOLE_NO_WRITE_CONTRACT_ZH.md](./FOUNDER_CONSOLE_NO_WRITE_CONTRACT_ZH.md)：P133 no-write contract，定义 future founder-console reads、explicit report outputs、forbidden writes 和 verification expectations。
- [FOUNDER_CONSOLE_ACCEPTANCE_CRITERIA.md](./FOUNDER_CONSOLE_ACCEPTANCE_CRITERIA.md) / [FOUNDER_CONSOLE_ACCEPTANCE_CRITERIA_ZH.md](./FOUNDER_CONSOLE_ACCEPTANCE_CRITERIA_ZH.md)：P134 acceptance criteria，定义 future founder-console visibility、no-write behavior、boundary display 和 failure conditions。
- [FOUNDER_CONSOLE_RISK_REVIEW.md](./FOUNDER_CONSOLE_RISK_REVIEW.md) / [FOUNDER_CONSOLE_RISK_REVIEW_ZH.md](./FOUNDER_CONSOLE_RISK_REVIEW_ZH.md)：P135 risk review，覆盖 founder-console product creep、Companion creep、automation、write paths、adapters、model calls、temporal overreach 和 capability overreach。
- [FOUNDER_CONSOLE_ROADMAP.md](./FOUNDER_CONSOLE_ROADMAP.md) / [FOUNDER_CONSOLE_ROADMAP_ZH.md](./FOUNDER_CONSOLE_ROADMAP_ZH.md)：P136 roadmap，收口 founder-console planning，并后推 implementation，直到 context package contracts 存在。
- [CONTEXT_PACKAGE_BUILDER_RFC.md](./CONTEXT_PACKAGE_BUILDER_RFC.md) / [CONTEXT_PACKAGE_BUILDER_RFC_ZH.md](./CONTEXT_PACKAGE_BUILDER_RFC_ZH.md)：P137 RFC-only context package contract，用于 future model-as-resource preparation。
- [CONTEXT_PACKAGE_PREVIEW_CLI_PLAN.md](./CONTEXT_PACKAGE_PREVIEW_CLI_PLAN.md) / [CONTEXT_PACKAGE_PREVIEW_CLI_PLAN_ZH.md](./CONTEXT_PACKAGE_PREVIEW_CLI_PLAN_ZH.md)：P138 document-only plan，规划 future local deterministic read-only context package preview CLI。
...
- [REBUILD_MIGRATION_PROTOCOL_RFC.md](./REBUILD_MIGRATION_PROTOCOL_RFC.md) / [REBUILD_MIGRATION_PROTOCOL_RFC_ZH.md](./REBUILD_MIGRATION_PROTOCOL_RFC_ZH.md)：P147 RFC-only rebuild migration protocol，定义 future local rebuild entry gates 和 stop conditions。
...
它不运行 rebuild、不调用模型、不连接 adapter、不写 state，也不批准 P152/P153/P154/P155/P156。
