...
当前工作状态：P113 Harness Source Inventory 已完成。future read-only source loader 现在有了第一版显式
Markdown 白名单和 pressure mapping；任意路径、state logs、adapter exports、memory dumps、network
sources、credentials 和 rebuild work 仍然 blocked。
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md)：P0-P113 foundation phase index，按核心命题和所属主线整理。
