...
| R15 | Bilingual drift | medium | Chinese and English docs diverge on status or blocked actions | run bilingual consistency passes and prefer paired edits | treating one language as authoritative when contradictory |
