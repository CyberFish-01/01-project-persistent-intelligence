...
Current work status: P121 Core Lockdown Mode RFC is complete. The project now
has an RFC-only boundary for freezing the core before any future old 01 import,
model output, adapter context, tool evidence, external IO, or rebuild pressure
can touch trusted state. It does not implement lockdown runtime or writes.
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md): P0-P121 foundation phase index by proposition and main line.
