...
Current work status: P105 Harness Boundary Monitor Hardening is complete. The
local read-only `harness-dry-run` command now shows structured disabled
capabilities, unchanged state, active boundary violations, and highlighted
profile-specific boundaries while staying dry-run only.
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md): P0-P105 foundation phase index by proposition and main line.
