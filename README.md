...
Current work status: P148 Rebuild Entry Gate Checklist is complete. The project
now distinguishes ready-for-verification from ready-for-rebuild and lists the
evidence required before local 01 rebuild can be considered; rebuild remains
blocked.
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md): P0-P148 foundation phase index by proposition and main line.
