...
Current work status: P133 Founder Console No-Write Contract is complete. A
future console may only produce explicit report outputs and must not write core
history, formal state, memory, recall, identity, tools, adapters, or rebuild
migration files.
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md): P0-P133 foundation phase index by proposition and main line.
