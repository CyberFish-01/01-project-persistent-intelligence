...
Current work status: P108 Harness Usability Re-Review is complete. The local
read-only `harness-dry-run` command improved from the P101 6.5/10 usability
baseline to 8.0/10 after pressure routing, specialized candidates, specialized
review gates, and hardened boundary visibility.
...
- [PHASE_INDEX.md](./PHASE_INDEX.md) / [PHASE_INDEX_ZH.md](./PHASE_INDEX_ZH.md): P0-P108 foundation phase index by proposition and main line.
